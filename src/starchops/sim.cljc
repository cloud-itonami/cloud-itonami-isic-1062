(ns starchops.sim
  "Simulation driver for testing the starches-and-starch-products
  ...
  Example flow:
    ...
    3. Propose a batch -> :extract transition with extraction parameters
    4. Governor validates parameters against facts
    5. If valid, audit fact is committed
    6. CLI prints audit trail")

(defn -main [& _args]
  (println "StarchOps simulation: not yet implemented.")

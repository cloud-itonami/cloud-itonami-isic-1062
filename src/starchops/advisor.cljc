(ns starchops.advisor
  "StarchOpsAdvisor -- the LLM/decision-maker that proposes operations.

  The advisor operates purely at the proposal level; the Governor (starchops.governor)

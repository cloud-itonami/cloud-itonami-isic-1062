# Operator Quickstart — Starches and Starch Products Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1062** (`cloud-itonami-isic-1062`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1062.git
cd cloud-itonami-isic-1062
```
...
- Blueprint governor key: `starchops-governor`
- Likely source path: `starchops.governor.cljc`

...
If you discover a security issue in cloud-itonami-isic-1062, **do not open a
...
This repository implements the **Governor** for starches-and-starch-products
...
1. **Hard violations in Governor rules must never be overridable** — a rule
   marked as HARD (e.g., `:already-processed`, `:sulfite-residue-exceeded`,
   `:microbial-load-exceeded`, `:foreign-material-detected`) blocks the
